...
## 🛠 How it Works
Create: Set up your custom lists.
Track: Whenever an item is finished, simply update its status in the app.
Receive: Once a week, get a consolidated shopping list tailored to your actual needs.
